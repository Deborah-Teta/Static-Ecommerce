A beautiful, responsive E-commerce application built with HTML, tailwindCSS,JavaScript and React. This app allows the user exlpore and shop the products they like
